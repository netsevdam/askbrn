...
class UploadModel extends BaseModel
{
    ...
    {
        $newName = 'img_' . generateToken() . '.webp';
    ...
    public function uploadPostImage($tempPath, $type)
    {
        ...
        $newPath = 'uploads/images/' . $this->createUploadDirectory('images') . $name . uniqid() . '.webp';
    ...
    public function uploadQuizImage($tempPath, $type)
    {
        ...
        $newPath = 'uploads/quiz/' . $this->createUploadDirectory('quiz') . $name . uniqid() . '.webp';
        $img->save(FCPATH . $newPath, $this->imgQuality);
        return $newPath;
    }
    ...
    {
        $newPath = 'uploads/gallery/' . $this->createUploadDirectory('gallery') . 'image_' . $width . 'x_' . uniqid() . '.webp';
        $img = Image::make($tempPath)->orientate();
    ...
    public function uploadAvatar($userId, $path)
    {
        ...
        $newPath = 'uploads/profile/' . $directory . 'avatar_' . $userId . '_' . uniqid() . '.webp';
    ...
    {
        return $this->upload($inputName, "uploads/logo/", "logo_", ['jpg', 'jpeg', 'png', 'gif', 'svg', 'webp']);
    }
    ...
    {
        return $this->upload($inputName, "uploads/logo/", "favicon_", ['jpg', 'jpeg', 'png', 'gif', 'webp']);
    }

    //ad upload
    public function uploadAd($inputName)
    {
        return $this->upload($inputName, "uploads/blocks/", "block_", ['jpg', 'jpeg', 'png', 'gif', 'webp']);
    }
    ...
    function downloadTempImage($url, $ext, $fileName = 'temp')
    {
        ...
        $pathWEBP = FCPATH . 'uploads/tmp/' . $fileName . '.webp';

...
class LanguageModel extends BaseModel
{
    ...
    public function addLanguageRows($langId)
    {
        ...
        $settings = [
            'lang_id' => $langId,
            'site_title' => 'Askbrn - News Magazine',
            'home_title' => 'Index',
            'site_description' => 'Askbrn - News Magazine',
            'keywords' => 'Askbrn, News, Magazine',
            'application_name' => 'Askbrn',
            'primary_font' => 19,
            'secondary_font' => 25,
            'tertiary_font' => 32,
            'facebook_url' => '',
    ...
    {
        $page = ['lang_id' => $langId, 'title' => 'Gallery', 'slug' => 'gallery', 'description' => 'Askbrn Gallery Page', 'keywords' => 'askbrn, gallery , page', 'is_custom' => 0, 'page_default_name' => 'gallery', 'page_content' => '', 'page_order' => 2, 'visibility' => 1, 'title_active' => 1, 'breadcrumb_active' => 1, 'right_column_active' => 0, 'need_auth' => 0, 'location' => 'main', 'link' => '', 'parent_id' => 0, 'page_type' => 'page',];
        $this->db->table('pages')->insert($page);

        $page = ['lang_id' => $langId, 'title' => 'Contact', 'slug' => 'contact', 'description' => 'Askbrn Contact Page', 'keywords' => 'askbrn, contact, page', 'is_custom' => 0, 'page_default_name' => 'contact', 'page_content' => '', 'page_order' => 1, 'visibility' => 1, 'title_active' => 1, 'breadcrumb_active' => 1, 'right_column_active' => 0, 'need_auth' => 0, 'location' => 'top', 'link' => '', 'parent_id' => 0, 'page_type' => 'page',];
        $this->db->table('pages')->insert($page);

        $page = ['lang_id' => $langId, 'title' => 'Terms & Conditions', 'slug' => 'terms-conditions', 'description' => 'Askbrn Terms Conditions Page', 'keywords' => 'askbrn, terms, conditions', 'is_custom' => 0, 'page_default_name' => 'terms_conditions', 'page_content' => '', 'page_order' => 1, 'visibility' => 1, 'title_active' => 1, 'breadcrumb_active' => 1, 'right_column_active' => 0, 'need_auth' => 0, 'location' => 'footer', 'link' => '', 'parent_id' => 0, 'page_type' => 'page',];
        $this->db->table('pages')->insert($page);
    }

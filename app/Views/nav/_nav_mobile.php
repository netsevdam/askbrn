...
<?php if ($darkMode == 1): ?>
<button type="submit" name="theme_mode" value="light" class="btn-switch-mode-mobile"><i class="no-text">btn switch mode</i>
...
<?php else: ?>
<button type="submit" name="theme_mode" value="dark" class="btn-switch-mode-mobile"><i class="no-text">btn switch</i>

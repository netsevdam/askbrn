                    ...
                    <?php if (!empty($sliderPosts)): ?>
                        <div class="slider-container" <?= $rtl == true ? 'dir="rtl"' : ''; ?>>
                                    ...
                                    if ($count < 20):?>
                                        <div class="featured-slider-item">
                                            ...
                                            <a href="<?= generatePostURL($post); ?>" class="img-link"<?php postURLNewTab($post); ?>>
                                                <?= view("post/_post_image", ['postItem' => $post, 'type' => 'featured_slider']); ?>
                                            </a>
                                            <div class="caption">
                                                <h2 class="title">
                            ...
                            <div id="featured-slider-nav" class="featured-slider-nav">
                                <button class="prev"><span class="no-text">prev</span>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                                        <path fill-rule="evenodd" d="M11.354 1.646a.5.5 0 0 1 0 .708L5.707 8l5.647 5.646a.5.5 0 0 1-.708.708l-6-6a.5.5 0 0 1 0-.708l6-6a.5.5 0 0 1 .708 0z"/>
                                    </svg>
                                </button>
                                <button class="next"><span class="no-text">next</span>
                                    ...
                                    <div class="featured-box box-<?= $count; ?>">
                                        <div class="box-inner">
                                            ...
                                            <a href="<?= generatePostURL($item); ?>"<?php postURLNewTab($item); ?>>
                                                <?= view("post/_post_image", ["postItem" => $item, "type" => "featured"]); ?>
                                                <div class="overlay"></div>
                                            </a>
                                            <div class="caption">
                                                <h3 class="title"><?= esc(characterLimiter($item->title, 50, '...')); ?></h3>
                                                <p class="post-meta"><?= view("post/_post_meta", ["post" => $item]); ?></p>
                                            </div>
                                        </div>
                                    </div>
                                <?php endif;

<div class="box">
  <div class="box-body">
    <div class="form-group">
      ...
      <input type="text" id="wr_input_post_title" class="form-control" name="title" placeholder="<?= trans('title_length_info'); ?>" value="<?= old('title'); ?>" maxlength="60" required>
    </div>
    ...
    <div class="form-group">
      ...
      <textarea class="form-control text-area" name="summary" placeholder="<?= trans('description_meta_allowed'); ?>" maxlength="155" required><?= old('summary'); ?></textarea>
    </div>

    <div class="form-group">
      <label class="control-label"><?= trans('keywords'); ?> (<?= trans('meta_tag'); ?>)</label>
      <input type="text" class="form-control" name="keywords" placeholder="<?= trans('keywords'); ?> (<?= trans('meta_tag'); ?>)" value="<?= old('keywords'); ?>" maxlength="60" required>
    </div>

...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/admin/css/custom-2.0.min.css'); ?>">
    <script src="<?= base_url('assets/admin/plugins/jQuery/jQuery-3.6.0.min.js'); ?>"></script>
    ...
    <?php if ($activeLang->text_direction == 'rtl'): ?>
        <link href="<?= base_url('assets/admin/css/rtl-2.0.min.css'); ?>" rel="stylesheet"/>
                ...
                <ul class="sidebar-menu" data-widget="tree" style="padding-bottom: 160px;">
                    ...
                    if (checkUserPermission('settings')): ?>
                        ...
                        <li class="nav-visual-settings">
                            <a href="<?= adminUrl('visual-settings'); ?>"><i class="fa fa-paint-brush"></i><span><?= trans("visual_settings"); ?></span></a>
                        </li>

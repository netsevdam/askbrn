...
<script>
    function initTinyMCE(selector, minHeight) {
        var menuBar = 'file edit insert format table help';
        ...
        tinymce.init({
          ...
          menubar: menuBar,
          toolbar: 'fullscreen preview | undo redo | bold italic underline strikethrough | codesample image media link | alignleft aligncenter alignright alignjustify | numlist bullist | forecolor backcolor removeformat | outdent indent',
          plugins: [

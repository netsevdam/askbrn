    ...
    <div class="widget-body">
        <div class="random-slider-container">
            ...
            <div id="random-slider-nav" class="slider-nav random-slider-nav">
                <button class="prev"><span class="no-text">prev</span><i class="icon-arrow-left"></i></button>
                <button class="next"><span class="no-text">next</span><i class="icon-arrow-right"></i></button>
            </div>
        </div>
    </div>
</div>
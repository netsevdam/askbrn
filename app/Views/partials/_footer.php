                                            ...
                                            <?php if (checkPostImg($item)): ?>
                                                <div class="list-left">
                                                    <a href="<?= generatePostURL($item); ?>"<?php postURLNewTab($item); ?>>
                                                        <?= view('post/_post_image', ['postItem' => $item, 'type' => 'small']); ?>
                                                    </a>
                                                </div>
                                            <?php endif; ?>
            ...
            <div class="col-sm-4 col-xs-12">
                <div class="col-sm-12 footer-widget f-widget-follow">
                    <div class="row">
                        ...
                        <ul>
                            <?= view('partials/_social_media_links', ['rssHide' => false]); ?>
                        </ul>
                    </div>
                </div>
...
<a href="#" class="scrollup"><span class="no-text">top</span><i class="icon-arrow-up"></i></a>

<script src="<?= base_url('assets/js/jquery-3.6.0.min.js'); ?>"></script>
<script src="<?= base_url('assets/js/plugins-2.0.js'); ?>"></script>
<?php if (checkCronTime(3)): ?>
<script>$.ajax({type: 'POST', url: "<?= base_url('vr-internal-cron'); ?>"});</script>
<?php endif;
if ($baseSettings->cookies_warning && empty(helperGetCookie('cookies_warning'))): ?>

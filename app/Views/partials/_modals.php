                    ...
                    <div class="modal-body">
                        <div class="auth-box">
                            <div class="social-login">
                                <?= view("partials/_social_login", ['orText' => trans("or_register_with_email")]); ?>
                            </div>
                        ...
                        if ($generalSettings->post_format_article == 1):
                            ...
                            <div class="col-xs-12 col-sm-4 col-add-post">
                                <a href="<?= adminUrl('add-post?type=article'); ?>">
                                    <div class="item">
                                        <div class="item-icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="<?= $generalSettings->site_color; ?>" class="bi bi-file-earmark-text" viewBox="0 0 16 16">
                        ...
                        if ($generalSettings->post_format_gallery == 1):
                            ...
                            <div class="col-xs-12 col-sm-4 col-add-post">
                                <a href="<?= adminUrl('add-post?type=gallery'); ?>">
                                    <div class="item">
                                        <div class="item-icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="<?= $generalSettings->site_color; ?>" class="bi bi-images" viewBox="0 0 16 16">
                        ...
                        if ($generalSettings->post_format_sorted_list == 1):
                            ...
                            <div class="col-xs-12 col-sm-4 col-add-post">
                                <a href="<?= adminUrl('add-post?type=sorted_list'); ?>">
                                    <div class="item">
                                        <div class="item-icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="<?= $generalSettings->site_color; ?>" class="bi bi-list-ol" viewBox="0 0 16 16">
                        ...
                        if ($generalSettings->post_format_trivia_quiz == 1):
                            ...
                            <div class="col-xs-12 col-sm-4 col-add-post">
                                <a href="<?= adminUrl('add-post?type=trivia_quiz'); ?>">
                                    <div class="item">
                                        <div class="item-icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="<?= $generalSettings->site_color; ?>" class="bi bi-ui-checks-grid" viewBox="0 0 16 16">
                        ...
                        if ($generalSettings->post_format_personality_quiz == 1):
                            ...
                            <div class="col-xs-12 col-sm-4 col-add-post">
                                <a href="<?= adminUrl('add-post?type=personality_quiz'); ?>">
                                    <div class="item">
                                        <div class="item-icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="<?= $generalSettings->site_color; ?>" class="bi bi-ui-checks" viewBox="0 0 16 16">
                        ...
                        if ($generalSettings->post_format_video == 1):
                            ...
                            <div class="col-xs-12 col-sm-4 col-add-post">
                                <a href="<?= adminUrl('add-post?type=video'); ?>">
                                    <div class="item">
                                        <div class="item-icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="<?= $generalSettings->site_color; ?>" class="bi bi-play-circle" viewBox="0 0 16 16">
                        ...
                        if ($generalSettings->post_format_audio == 1): ?>
                            <div class="col-xs-12 col-sm-4 <?= $formatCount == 6 ? 'col-sm-offset-4 ' : ''; ?>col-add-post">
                                <a href="<?= adminUrl('add-post?type=audio'); ?>">
                                    <div class="item">
                                        <div class="item-icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="<?= $generalSettings->site_color; ?>" class="bi bi-music-note-beamed" viewBox="0 0 16 16">

<?php if (!empty($subCategories)): ?>
    <ul id="<?= "tabs-" . esc($category->name_slug) . "-" . esc($category->id); ?>" class="nav nav-tabs pull-right sub-block-tabs" role="tablist">
        ...
        <?php if (countItems($subCategories) >= 5): ?>
            <li>
                <a href="javascript:void(0)" class="dropdown-toggle btn-block-more" type="button" data-toggle="dropdown"><i class="no-text">dropdown</i><span class="icon-ellipsis-h more subcategories-more-icon"></span></a>
